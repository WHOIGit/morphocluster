...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["parent_id"], ["nodes.node_id"], name="nodes_parent_id_fkey"
        ),
        sa.ForeignKeyConstraint(
            ["project_id"], ["projects.project_id"], name="nodes_project_id_fkey"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["node_id"],
            ["nodes.node_id"],
            name="nodes_objects_node_id_fkey",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["object_id"],
            ["objects.object_id"],
            name="nodes_objects_object_id_fkey",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["project_id"],
            ["projects.project_id"],
            name="nodes_objects_project_id_fkey",
            ondelete="CASCADE",
        ),
        sa.UniqueConstraint(
            "project_id", "object_id", name="nodes_objects_project_id_object_id_key"
        ),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["node_id"], ["nodes.node_id"], name="log_node_id_fkey", ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["username"],
            ["users.username"],
            name="log_username_fkey",
            ondelete="SET NULL",
        ),
